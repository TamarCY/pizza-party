...
const {getParty, postParty, signinParty, logoutParty, updateParty, getPartyById, sumGuestsPizza} = require("../controllers/party-controllers")
...
partyRouter.get("/sum-guest-pizza/:id", sumGuestsPizza);
